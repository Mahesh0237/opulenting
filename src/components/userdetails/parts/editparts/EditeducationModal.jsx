import { Button, Card, Grid, Group, Input, LoadingOverlay, Radio, Select, Text, TextInput } from '@mantine/core'
...
function EditeducationModal({ refresherEducationData, closeEditEducationModal, editId }) {
    ...
    useEffect(() => {
        ...
        const starCountRef = ref(db, `users/${userid}/userdetails/EducationData/${editId}`);
    ...
    const updateForm = () => {
        ...
        set(ref(db, `users/${userid}/userdetails/EducationData/${editId}`), {
            qualification,
            university,
            course,
            courseType,
        ...
        <Card withBorder py="md" className='loginform'>
            ...
            <Card.Section inheritPadding pt={20}>
                <Group position='apart'>
                    <Button variant='default' onClick={closeEditEducationModal}> close</Button>
