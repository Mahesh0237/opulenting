...
function Antifraudpolicywrapper() {
    ...
    return (
        <>
            ...
            <Stack className='products-position-property'>
                <Text size={newsize} weight={600} color='white' ta="center">Anti Fraud Policy</Text>
                <Text className='policy'></Text>
            </Stack>
            <Container py={30}>
                <Card withBorder >
                    <Card.Section inheritPadding py={10}>
                        <Text size={20} weight={600} color='#e30303' ta="center">Anti Fraud Policy</Text>
                    </Card.Section>
...
export default Antifraudpolicywrapper